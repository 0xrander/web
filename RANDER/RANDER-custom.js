            ...
            function D(e) {
                ...
                return (0, s.useEffect)(() => {
                    if (o.countViews && (0, t.ed)(h.toString()), o.presence) {
                        let e = new WebSocket("wss://".concat("https://your-server/".replace("https://", ""), "/bio/presence/").concat(h));
                    ...
                    children: [(0, r.jsx)(l.PB, {
                        ...
                        canonical: "https://your-server/".concat(o.url),
                        themeColor: o.color,
                        openGraph: {
                            url: "https://your-server/".concat(o.url),
                            title: o.name,
                            description: o.description,
                            images: [{
                                url: o.pfp.url,
